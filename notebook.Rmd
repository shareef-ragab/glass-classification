...
confusionMatrix(testDate$RIcluster, PredictRIClusetrGlmnet, mode = "everything")
```
...
confusionMatrix(testDate$RIcluster, PredictRIClusetrSvmRadial, mode = "everything")
```
...
confusionMatrix(testDate$RIcluster, PredictRIClusetrRf, mode = "everything")
```
...
confusionMatrix(testDate$RIcluster, PredictRIClusetrNnet, mode = "everything")
```
```{r}
